...
\newglossaryentry{Working Copy}{
    name = {Working Copy},
    description = {die lokale Kopie eines Online Repositories. In dieser Kopie können Änderungen gemacht werden.}
}

\newglossaryentry{Markdown}{
    name = {Markdown},
    description = {eine Markup-Sprache, welche das Formatieren von Text ermöglicht}
}